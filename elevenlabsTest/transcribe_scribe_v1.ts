...
async function transcribeWithScribeV1() {
  ...
  console.log('Starting transcription with scribe_v1...');
  ...
  try {
    ...
    const outputPath = '/Users/mia/nora/elevenlabsTest/scribe_v1_result.json';

  ...
  return (
    <OnboardingLayout progress={48} backTo="/onboarding/child-issue">
      ...
      <div className="flex-1 overflow-y-auto px-6 pt-4 pb-4">
        <div className="bg-[#EDE9FE] rounded-xl px-4 py-3 mb-6">
          <p className="text-[#8C49D5] font-semibold text-sm">
            Hi {name}, you're in the right place.
          </p>
        </div>

        <h1 className="text-[#1E2939] text-2xl font-bold mb-3 leading-tight">
        ...
        <div className="flex flex-col gap-3">
          {items.map(item => (
            <div key={item.title} className="flex items-center gap-4 border border-gray-200 rounded-xl p-4">

        ...
        <nav className="sidebar-nav">
          ...
          {isAdmin && (
            <>
              ...
              <NavLink to="/content-v2" className={({ isActive }) => isActive ? 'nav-item active' : 'nav-item'}>
              ...
              <NavLink to="/home-cards" className={({ isActive }) => isActive ? 'nav-item active' : 'nav-item'}>
              ...
              <NavLink to="/demo-videos" className={({ isActive }) => isActive ? 'nav-item active' : 'nav-item'}>
              ...
              <NavLink to="/coding-review" className={({ isActive }) => isActive ? 'nav-item active' : 'nav-item'}>
              ...
              <NavLink to="/free-accounts" className={({ isActive }) => isActive ? 'nav-item active' : 'nav-item'}>
